...
Anyone that goes on the website can check their waist to hip ratio on the Welcome page, where there the calculator is, and check on the table for the result. Knowing the result they're also able to see all the trainers (who are signed up) and email them to be a potential client.
